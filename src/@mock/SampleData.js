...
export const events = [
    {title: "event", date: "2022-05-11", end: "2022-05-12", allDay: true, calendar: "indigo"},
    {title: "event", start: "2022-05-11", end: "2022-05-11", allDay: false, calendar: "indigo"},
    {title: "event", date: "2022-05-12", end: "2022-05-13", allDay: true, calendar: "cyan"},
    {title: "event", date: "2022-05-12", end: "2022-05-13", allDay: false, calendar: "cyan"},
    {title: "event", start: "2022-05-09", end: "2022-05-09", allDay: true, calendar: "red"},
    ...
    {title: "event", start: "2022-05-01", end: "2022-05-02", allDay: true, calendar: "pink"},
    {title: "event", start: "2022-05-01", end: "2022-05-02", allDay: false, calendar: "pink"},
    {title: "event", start: "2022-05-21", end: "2022-05-22", allDay: true, calendar: "teal"},
    {title: "event", start: "2022-05-21", end: "2022-05-22", allDay: false, calendar: "teal"},
    {title: "event", start: "2022-05-03", end: "2022-05-04", allDay: true, calendar: "orange"},
    {title: "event", start: "2022-05-03", end: "2022-05-04", allDay: false, calendar: "orange"},
    {title: "event", start: "2022-05-13", end: "2022-05-14", allDay: true, calendar: "sky"},
    {title: "event", start: "2022-05-13", end: "2022-05-14", allDay: false, calendar: "sky"},
    {title: "event", start: "2022-05-14", end: "2022-05-15", allDay: true, calendar: "blue"},
    {title: "event", start: "2022-05-14", end: "2022-05-15", allDay: false, calendar: "blue"},
    {title: "event", start: "2022-05-16", end: "2022-05-17", allDay: true, calendar: "cyan"},
    {title: "event", start: "2022-05-16", end: "2022-05-17", allDay: false, calendar: "cyan"},
    {title: "event", start: "2022-05-17", end: "2022-05-18", allDay: true, calendar: "green"},
